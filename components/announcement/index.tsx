...
export default function Announcement() {
  return (
    <div className="announcement flex flex-col justify-center items-center">
      <div className="wrapper">
        <div className=" grid grid-cols-3 grid-rows-3 gap-2">
          <Link href="#">
            <div className="col-span-1 flex flex-col justify-center items-center border border-white92 text-center py-20 gap-20 rounded-lg shadow overflow-hidden">
              <div
                aria-hidden="true"
              ...
              <div className=" flex flex-col justify-center items-center relative h-full">
                ...
                <p className="text-textgray font-normal text-xl text-center tracking-tight leading-relaxed mt-9">
                  Bring the power of full-stack <span className="block"></span>{" "}
                  to the frontend.
                </p>
              </div>
          ...
          <Link href="">
            <div className="flex flex-col justify-center items-center border border-white92 relative text-center rounded-lg p-8  shadow overflow-hidden">
              <div
                aria-hidden="true"
                className="uppercase font-semibold text-textgray text-base border border-white92 px-1 rounded-md absolute top-3 bg-gray05 right-3"
              >
                Beta
              </div>
              <Image
          ...
          <Link href="">
            <div className="col-start-2 col-end-3 row-start-3 row-end-4 announcement-link flex flex-col justify-center items-center border border-white92 text-center py-4 rounded-lg shadow overflow-hidden relative ">
              <div className=".announcement-subtext flex flex-col justify-center items-center relative text-gray444 gap-4 my-6 pb-28">
                ...
                <p className="font-normal text-xl text-textgray max-w-xs">
                  ...
                  now makes <span className="text-black">server-first</span> the
                  default.
                </p>
          ...
          <Link href="">
            <div className="col-start-3 col-end-4 row-start-1 row-end-2 announcement-link flex flex-col justify-center items-center border border-white92 text-center p-8 rounded-lg shadow overflow-hidden relative ">
              ...
              {/* <Image
                ...
                width={256}
                height={90}
                className="next-announcements_assetVisual mt-8 invert"
              /> */}
              <div>
                <svg
          ...
          <Link href="">
            <div className="col-start-3 col-end-4 row-start-3 row-end-4 flex flex-col justify-center items-center border border-white92 text-center p-4 gap-6 rounded-lg shadow overflow-hidden">
              <Image src="/globe-light.png" alt="" width={280} height={185} className="" />
              <div className="flex flex-col justify-center items-center text-center mb-9">
                <h3 className="announcement-subtext font-medium text-2xl">
                  Dynamic HTML Streaming
                </h3>
                <p className="font-normal text-xl text-textgray max-w-sm mt-3">
                  Support for HTML streaming, <br />now on Vercel.
                </p>
              </div>
            </div>
          </Link>
