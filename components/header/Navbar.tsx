...
export default function Example() {
  ...
  return (
    <header className="flex flex-col justify-center items-center w-full bg-blue-500">
      <div className="flex flex-col items-center w-full">
        ...
        >
          ...
          <div className="navbar-header-buttons flex justify-between items-center gap-2">
            <Link href="#">
              <div className="Nextjs-Conf-Btn relative justify-center items-center rounded bg-white shadow py-2 px-3 overflow-hidden text-black text-sm before:animate-fullSpin hover:text-gray">
                Next.js Conf
              </div>
            </Link>
            <Link href="#">
