...
export default function GiestWrapper() {
    return (
        <div className="announcement-features wrapper flex justify-center  mt-20 mb-10">
        <div className=" flex flex-col  gap-9 lg:flex-row  justify-center lg:justify-between items-center relative py-12 lg:w-full mx-9">
